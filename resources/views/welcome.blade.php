...
<body>
                ...
                <div class="col-lg-6">
                    <div class="hero-content">
                        ...
                        <h1 class="display-4 fw-bold mb-4">
                            Welcome to<br>
                            <span class="text-warning">{{ config('app.church.name') }}</span><br>
                            Management System
                        </h1>
                        <p class="lead mb-4">
                            Empowering our church community in {{ config('app.church.location') }} with modern digital tools 
                            for fellowship management, attendance tracking, and spiritual growth.
                        </p>
                        @guest
                            <div class="d-grid gap-2 d-md-flex">
                                <a href="{{ route('login') }}" class="btn btn-church text-white me-md-2">
                        ...
                        @else
                            <a href="{{ route('dashboard') }}" class="btn btn-church text-white">
    ...
    <section class="py-5 bg-light">
        <div class="container text-center">
            ...
            @guest
                <a href="{{ route('register') }}" class="btn btn-church text-white btn-lg">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <p class="text-light">
                        {{ config('app.church.location') }}<br>
                        Email: {{ config('app.church.email') }}<br>
                        Phone: {{ config('app.church.phone') }}
                    </p>
                </div>
                <div class="col-md-6 text-md-end">
                    <h6 class="fw-bold mb-3">Church Management System</h6>
                    <p class="text-light">
                        Built with ❤️ for {{ config('app.church.name') }}<br>
            ...
            <hr class="my-4">
            <div class="text-center">
                <p class="mb-0">&copy; {{ date('Y') }} {{ config('app.church.name') }}. All rights reserved.</p>
            </div>
        </div>
    </footer>
